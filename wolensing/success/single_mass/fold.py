...
np.savez(f'source_{ym[0]}.npz', caus_ra=ra_caustic_list, caus_dec=dec_caustic_list, macro_ra=macro_srcx, macro_dec=macro_srcy, lens_ra=lens_srcx, lens_dec=lens_srcy)
exit()
