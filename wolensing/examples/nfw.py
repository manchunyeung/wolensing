...
Rs_angle, alpha_Rs = lens_cosmo.nfw_physical2angle(M=10**10, c=6)
...
lens_model_list = ['NFW']
kwargs_sis_1 = {'center_x': eta10, 'center_y': eta11, 'Rs':Rs, 'alpha_Rs':alpha_Rs}
...
fig, ax = plt.subplots()
plot_contour(ax, lens_model_list, 0, 0, 10*thetaE1, kwargs_lens_list, beta0, beta1, 0,0,
